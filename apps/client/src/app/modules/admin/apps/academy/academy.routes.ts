...
import { AcademyComponent } from '@modules/admin/apps/academy/academy.component';
import { AcademyService } from '@modules/admin/apps/academy/academy.service';
import { AcademyDetailsComponent } from '@modules/admin/apps/academy/details/details.component';
import { AcademyListComponent } from '@modules/admin/apps/academy/list/list.component';
