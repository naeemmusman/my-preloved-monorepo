...
import { ContactsComponent } from '@modules/admin/apps/contacts/contacts.component';
import { ContactsService } from '@modules/admin/apps/contacts/contacts.service';
import { ContactsDetailsComponent } from '@modules/admin/apps/contacts/details/details.component';
import { ContactsListComponent } from '@modules/admin/apps/contacts/list/list.component';
