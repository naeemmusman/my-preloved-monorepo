...
import { FileManagerDetailsComponent } from '@modules/admin/apps/file-manager/details/details.component';
import { FileManagerComponent } from '@modules/admin/apps/file-manager/file-manager.component';
import { FileManagerService } from '@modules/admin/apps/file-manager/file-manager.service';
