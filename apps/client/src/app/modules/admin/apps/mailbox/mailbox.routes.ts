...
import { MailboxDetailsComponent } from '@modules/admin/apps/mailbox/details/details.component';
import { MailboxEmptyDetailsComponent } from '@modules/admin/apps/mailbox/empty-details/empty-details.component';
import { MailboxListComponent } from '@modules/admin/apps/mailbox/list/list.component';
import { MailboxComponent } from '@modules/admin/apps/mailbox/mailbox.component';
import { MailboxService } from '@modules/admin/apps/mailbox/mailbox.service';
import { MailboxSettingsComponent } from '@modules/admin/apps/mailbox/settings/settings.component';
