...
import {
    labelColorDefs,
    labelColors,
} from '@modules/admin/apps/mailbox/mailbox.constants';
import { MailboxService } from '@modules/admin/apps/mailbox/mailbox.service';
import { MailLabel } from '@modules/admin/apps/mailbox/mailbox.types';
...
export class MailboxSettingsComponent implements OnInit {
    ...
    deleteLabel(id: string): void {
        ...
        const labelsFormArray = this.labelsForm.get(
            'labels'
        ) as UntypedFormArray;
    ...
    updateLabels(): void {
        ...
        (this.labelsForm.get('labels') as UntypedFormArray).controls.forEach(
            (labelFormGroup) => {
