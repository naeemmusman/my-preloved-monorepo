...
import { NotesDetailsComponent } from '@modules/admin/apps/notes/details/details.component';
import { NotesLabelsComponent } from '@modules/admin/apps/notes/labels/labels.component';
import { NotesService } from '@modules/admin/apps/notes/notes.service';
import { Label, Note } from '@modules/admin/apps/notes/notes.types';
