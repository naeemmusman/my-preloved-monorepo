...
import { TasksDetailsComponent } from '@modules/admin/apps/tasks/details/details.component';
import { TasksListComponent } from '@modules/admin/apps/tasks/list/list.component';
import { TasksComponent } from '@modules/admin/apps/tasks/tasks.component';
import { TasksService } from '@modules/admin/apps/tasks/tasks.service';
